...
func UEachEdge[W any, G groph.RUndirected[W]](g G, onEdge groph.VisitEdge[W]) bool {
	ord := g.Order()
...
func DEachEdge[W any, G groph.RDirected[W]](g G, onEdge groph.VisitEdge[W]) bool {
	ord := g.Order()
	for u := groph.VIdx(0); u < ord; u++ {
